...
if __name__ == "__main__":
    ...
    parser.add_argument("--model_name", type=str, default="atdkt_que")
    ...
    parser.add_argument("--loss_pred", type=float, default=0.5)
    parser.add_argument("--loss_his", type=float, default=0.5)
